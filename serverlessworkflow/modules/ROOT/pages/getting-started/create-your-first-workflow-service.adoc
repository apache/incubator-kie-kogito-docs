...
Also, you can directly access an example application by cloning `kogito-quarkus-examples/serverless-workflow-hello-world` from the https://github.com/hbelmiro/kogito-examples/tree/main/kogito-quarkus-examples/serverless-workflow-hello-world[GitHub repository].
...
. Once your Serverless Workflow application is started, you send a request for the provided endpoint:
+
--
.Example request
[source,shell]
