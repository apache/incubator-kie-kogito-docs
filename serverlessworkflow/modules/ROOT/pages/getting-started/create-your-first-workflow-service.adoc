...
In the previous command, `org.kie.kogito.examples`, `serverless-workflow-hello-world`, and `1.0` is group id, artifact id, and version of your project respectively. `-DnoCode` prevents workflow example code from being generated.
--
Knative CLI::
+
--
