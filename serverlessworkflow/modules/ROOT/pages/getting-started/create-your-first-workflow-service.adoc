...
Also, you can directly access an example application by cloning `serverless-workflow-examples/serverless-workflow-hello-world` from the {kogito_sw_examples_url}/serverless-workflow-hello-world[GitHub repository].
