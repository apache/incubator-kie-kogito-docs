...
+
--
Currently, Knative CLI doesn't support yet running workflows locally. You can either:
...
Also, to learn how to deploy and run your workflow application, see xref:cloud/deploying-on-minikube.adoc[{context} Deploying Serverless Workflow application on Minikube]
--
====
+
.Example response
