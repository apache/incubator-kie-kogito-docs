...
The first step is to set up an empty Maven project with the following dependency:
...
Also, you might optionally add a `simple logger for java` dependency to avoid using `System.out.println`
