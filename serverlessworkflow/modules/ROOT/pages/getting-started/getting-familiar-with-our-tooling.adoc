...
provides the best developer experience for the workflow ecosystem. The following tools are provided that you can use to author your workflow assets:
...
* xref:tooling/kn-plugin-workflow-overview.adoc[*Serverless Workflow plug-in for Knative CLI*]: Set up a local Serverless Workflow project using the command line.
