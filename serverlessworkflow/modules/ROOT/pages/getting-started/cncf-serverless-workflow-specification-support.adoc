...
{product_name} has a limited support of Timeouts feature, that covers only *Callback* and *Switch* states with events.
Other states will be included in the future releases.
