...
* link:{spec_doc_url}#correlation-definition[Correlation] has limited support. see xref:eventing/event-correlation-with-workflows.adoc[Event correlation with {context}].
