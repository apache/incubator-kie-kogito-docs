...
This guide showcases the use of our Knative Workflow CLI and Visual Studio code to run {product_name} projects.
...
To deploy the finished project to cluster, proceed to next section.
...
kn workflow deploy
----
* Using k9scli you can examine your deployment.
* In a different Terminal, create a port mapping:
[source,bash]
----
minikube service hello --namespace default --url
----
* Use this URL to access your workflow instance in the Developer UI
