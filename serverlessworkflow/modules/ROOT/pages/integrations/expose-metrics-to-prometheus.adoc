Exposing the workflow base metrics to Prometheus on Openshift
=============================================================
11-03-2022
:compat-mode!:
// Metadata:
...
[NOTE]
====
Kubernetes and minikube users can check the link:{prometheus_operator_url}[Prometheus Operator project].
====
