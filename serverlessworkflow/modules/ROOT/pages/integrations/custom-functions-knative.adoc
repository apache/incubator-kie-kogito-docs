...
[[enabling-knative-custom-functions]]
== Enabling Knative {context} custom functions

You can enable Knative {context} custom functions in your project.

.Procedure

To add Knative {context} custom functions to your workflow application, add the org.kie.kogito:kogito-addons-quarkus-knative-serving dependency to the `pom.xml` file of your project as follows:
...
[[declaring-custom-functions-for-knative]]
== Declaring {context} custom functions for Knative in the Workflow DSL
...
[[referencing-custom-functions-for-knative]]
== Referencing {context} custom functions for Knative in the Workflow DSL

To reference a {context} custom functions for Knative in the Workflow DSL, you must declare a `functionRef` like the following:
