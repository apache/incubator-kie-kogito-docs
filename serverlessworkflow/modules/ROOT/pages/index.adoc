...
[.card-description]
Learn how to configure OAuth 2.0 Token Exchange to call OpenAPI-secured services without forwarding end-user tokens
--
...
--
[.card-title]
xref:opentelemetry/index.adoc[OpenTelemetry integration overview]
[.card-description]
Learn about OpenTelemetry integration for enhanced observability and distributed tracing in workflow applications
--
...
[.card-description]
Understand the core concepts and components of OpenTelemetry integration in {product_name}
--
...
[.card-description]
Learn how to configure OpenTelemetry for your workflow applications with comprehensive examples
--
