...
--
[.card-title]
xref:cloud/deploying-on-minikube.adoc[Enhanced Service Discovery]
[.card-description]
Learn what is and how the Enhanced Service Discovery works
--

[.card]
--
[.card-title]
xref:cloud/enhanced-service-discovery.adoc[Deploying your {context} application on Minikube]
[.card-description]
