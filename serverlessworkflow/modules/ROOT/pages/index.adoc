...
--
[.card-title]
xref:cloud/knative-service-discovery.adoc[Knative service discovery in {context}]
[.card-description]
Learn what is and how the Knative service discovery for workflow application configuration works
--
