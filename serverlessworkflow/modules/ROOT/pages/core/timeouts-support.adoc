...
This property uses `ISO 8601` data and time standard to specify a duration of time. It follows the format `PnDTnHnMn.nS` with days considered to be exactly 24 hours. For instance,
`PT15M` configures 15 minutes, and `P2DT3H4M` defines 2 days, 3 hours and 4 minutes.
