...
[WARNING]
====
Avoid using only `java` functions or you can use the `java` functions to call the external services. Also, you can use the xref:service-orchestration/orchestration-of-opnapi-based-services.adoc[services orchestration features].
====
