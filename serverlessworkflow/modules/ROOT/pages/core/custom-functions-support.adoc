  ...
  "functions": [
    {
      "name": "greet", <1>
      "type": "custom", <2>
      "operation": "knative:services.v1.serving.knative.dev/custom-function-knative-service#plainJsonFunction", <3>
    }
  ]
----
  ...
  "functions": [
    {
      "name": "greet",
      "type": "custom",
      "operation": "knative:services.v1.serving.knative.dev/my_different_namespace/custom-function-knative-service#plainJsonFunction"
    }
  ]
----
  ...
  "functions": [
    {
      "name": "greet",
      "type": "custom",
      "operation": "knative:services.v1.serving.knative.dev/custom-function-knative-service#plainJsonFunction",
      "metadata": {
        "asCloudEvent": true <1>
      }
    }
