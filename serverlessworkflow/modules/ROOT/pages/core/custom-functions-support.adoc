  ...
  "functions": [
    {
      ...
      "metadata": { <4>
        ...
        "kind": "Service",
        "name": "custom-function-knative-service",
        "uri": "/plainJsonFunction"
      }
    }
  ]
----
...
<2> `custom` is the function type
<3> `knative` is the reserved keyword indicating that this is a Knative custom function
<4> In `metadata` you set the coordinates of the Knative service
  ...
  "functions": [
    {
      ...
      "metadata": {
        "apiVersion": "serving.knative.dev/v1",
        "kind": "Service",
        "namespace": "my_different_namespace",
        "name": "custom-function-knative-service",
        "uri": "/plainJsonFunction"
      }
    }
