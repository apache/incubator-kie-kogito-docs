...
[NOTE]
====
{product_name} generates a CloudEvent ID based on `source` and the workflow instance ID. In case an ID is set, {product_name} will ignore it and use a generated one.
====
