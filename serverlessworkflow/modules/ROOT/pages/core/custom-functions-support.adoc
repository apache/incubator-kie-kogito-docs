...
[WARNING]
====
Avoid using `java` functions to call the external services, instead you can use the xref:service-orchestration/orchestration-of-opnapi-based-services.adoc[services orchestration features].
====
