...
From now on, every workflow deployment in the development profile will use this image to run your application. Make sure that this new image is compatible with the original image.
