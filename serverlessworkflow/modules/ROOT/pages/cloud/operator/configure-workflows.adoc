...
[IMPORTANT]
====
This feature is supported only for development profile. Configuring workflows not in development are mapped and tracked by link:https://issues.redhat.com/browse/KOGITO-8522[KOGITO-8522]. See xref:cloud/operator/known-issues.adoc[]
====
