...
|`/deployments/config`
|Workflow Application properties. This path is used by the operator to mount managed and user properties, which must be accessible, and the application should be able to read them at runtime.
