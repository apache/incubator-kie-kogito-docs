...
* The xref:cloud/quarkus/kubernetes-service-discovery.adoc[Kubernetes service discovery] properties
* The xref:data-index/data-index-quarkus-extension.adoc[Data Index location properties]
* The xref:job-services/quarkus-extensions.adoc[Job Service location properties]
