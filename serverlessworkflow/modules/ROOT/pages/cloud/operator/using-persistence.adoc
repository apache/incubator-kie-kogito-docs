...
This configuration signals the operator that every workflow deployed in current SonataFlowPlatform's namespace must be properly configured to connect with that PostgreSQL database server.
