...
All the configurations shown in this guide apply exactly the same for both the `preview` and the `gitops` profiles. These configurations are ignored and you must not use them in the`dev` profile.
