...
In xref:cloud/operator/developing-workflows.adoc[development profile], it's expected that the image is based on the default `hub.docker.com/r/apache/incubator-kie-sonataflow-devmode:main`.
