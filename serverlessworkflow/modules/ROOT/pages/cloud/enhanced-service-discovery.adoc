...
that exposes a function, that can be discovered with the following SWUrl:
...
[NOTE]
====
Note that the SWUrl was translated to `http://greeting-quarkus-cli.serverless-workflow-greeting-quarkus.10.99.154.147.sslip.io` +
