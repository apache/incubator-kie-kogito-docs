...
+
Knative CLI offers a plugin called `quickstart` that will configure everything needed. To to install it follow these link:{kn_cli_quickstart_plugin_url}[steps].
+
