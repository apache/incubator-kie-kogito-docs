...
----
+
NOTE: The command above configures a Minikube profile called `knative`, from now on, all minikube commands will use this profile, to list the Minikube available profiles use the following command:
+
[source,shell]
----
