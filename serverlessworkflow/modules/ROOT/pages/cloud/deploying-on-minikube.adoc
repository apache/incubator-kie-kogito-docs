...
[NOTE]
====
To install everything manually, there is this link:{knative_on_minikube_step_by_step_url}[post] from the Red Hat Developers blog that guides you through the process.
====
+
