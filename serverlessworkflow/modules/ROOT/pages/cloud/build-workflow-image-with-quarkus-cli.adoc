...
a container image for this tutorial. If not, you can follow the Getting Started xref:getting-started/create-your-first-workflow-service.adoc[guide], or use the example project we've use in this tutorial.
