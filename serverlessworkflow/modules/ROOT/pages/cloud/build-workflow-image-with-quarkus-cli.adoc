...
// links
:example_project_url: https://github.com/kiegroup/kogito-examples/tree/main/serverless-workflow-examples/serverless-workflow-greeting-quarkus
...
----
git clone --branch main {kogito_sw_examples_git_repo_url} && cd kogito-examples/serverless-workflow-examples/serverless-workflow-greeting-quarkus
----
