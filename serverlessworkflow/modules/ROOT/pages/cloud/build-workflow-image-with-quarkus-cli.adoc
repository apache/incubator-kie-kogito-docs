...
First, you need to clone the {kogito_examples}[kogito-examples] repository and go to the {example-project}[serverless-workflow-greeting-quarkus] example.

.Cloning Kogito Examples
[source,shell,subs="attributes+"]
----
$ git clone --branch stable {kogito_examples} && cd kogito-examples/kogito-quarkus-examples/serverless-workflow-greeting-quarkus
----
