...
to run the OpenShift Serverless, which is based on Knative.
...
Before proceeding further, make sure that you have access to the OpenShift cluster with Serverless available and the
OpenShift Serverless operator is properly installed, to do this, please follow these link:{ocp_swf_install_url}[steps].
