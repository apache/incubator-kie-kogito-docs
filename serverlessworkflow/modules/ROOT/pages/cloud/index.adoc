...
== Operator Dev Profile
[.card]
--
[.card-title]
xref:cloud/operator/enable_devprofile.adoc[]
[.card-description]
Learn how to enable the dev profile on the Operator to use the Quarkus devmode
--

[.card]
--
[.card-title]
xref:cloud/operator/external_resources_configuration_for_workflow_CR_devprofile.adoc[]
[.card-description]
Learn how to use external resources configuration fin dev profile
--
