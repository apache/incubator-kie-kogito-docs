...
[TIP]
====
If you have used the Knative workflow CLI to create your project, then the Kogito Knative Eventing extension is already present. For more information about creating a project using Knative workflow CLI, see xref:tooling/kn-plugin-workflow-overview[Serverless Workflow plug-in for Knative CLI].
====
