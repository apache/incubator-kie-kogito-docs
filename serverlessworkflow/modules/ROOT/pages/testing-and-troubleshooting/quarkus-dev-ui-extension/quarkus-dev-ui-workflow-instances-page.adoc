...
To create a workflow instance, you can use the Workflow Definitions page. For more information, see xref:testing-and-troubleshooting/quarkus-dev-ui-extension/quarkus-dev-ui-workflow-definition-page.adoc[Workflow Definitions in Kogito Serverless Workflow Tools extension].
...
image::testing-and-troubleshooting/quarkus-dev-ui-extension/kogito-swf-tools-workflow-mermaid-diagram-panel.png[]
--
