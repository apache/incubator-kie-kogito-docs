...
The testing procedure in this document is based on the `serverless-workflow-examples/serverless-workflow-testing-with-rest-assured` example application. You can access this example application in link:{kogito_examples_url}[Kogito Examples] GitHub repository 
...
[NOTE]
====
This document is based on the `serverless-workflow-testing-with-rest-assured` example application from the link:{kogito_examples_url}[GitHub repository].
====
