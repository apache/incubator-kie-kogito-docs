...
[NOTE]
====
This document is based on the `serverless-workflow-testing-with-rest-assured` example application from the link:https://github.com/kiegroup/kogito-examples.git[GitHub repository].
====
