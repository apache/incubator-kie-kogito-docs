...
from the https://github.com/kiegroup/kogito-examples/tree/main/kogito-quarkus-examples/serverless-workflow-testing-with-rest-assured[GitHub repository].

This guide describes how to test a Serverless Workflow application that serves a `hello` endpoint.
