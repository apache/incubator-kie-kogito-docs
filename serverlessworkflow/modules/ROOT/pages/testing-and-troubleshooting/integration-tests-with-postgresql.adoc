...
[NOTE]
====
As a test resource, it will run its {quarkus_test_tesource_lifecycle_manager_class}[QuarkusTestResourceLifecycleManager] before the service test execution. More related info in {quarkus_testing_guide_test_resource}[Starting services before the Quarkus application starts].
====
