...
* Required tooling is installed. For more information, see {getting-familiar-with-our-tooling}[Getting familiar with Serverless Workflow tooling].
...
You can test your workflow application using the instructions described in xref:testing-and-troubleshooting/basic-integration-tests-with-restassured.adoc[Testing your Serverless Workflow application using REST Assured] document. 
