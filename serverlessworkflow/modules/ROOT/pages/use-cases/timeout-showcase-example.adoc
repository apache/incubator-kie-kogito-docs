...
This is the most complex and close to a production scenario. In this case, the workflows, the job service, the data index service, and the database, are deployed as standalone services in the kubernetes/knative cluster.
Additionally, the communications from the workflows to the job service, and from the jobs service to the data index service, are resolved via the knative eventing system.
