...
For more details about the Knative custom function, see xref:core/custom-functions-support.adoc#con-func-knative[Custom functions for your {product_name} service].
