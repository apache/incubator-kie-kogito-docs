...
[NOTE]
====
Note that in the above example, we are storing the `multiplication` and `substraction` OpenAPI files into the `src/main/resources/specs` folder of our application.
====
--
