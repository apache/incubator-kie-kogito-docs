...
[NOTE]
====
It is needed to prepare the {product_name} workflow to support the full communication with an external {data_index_ref} service.
...
<dependency>
  <groupId>org.kie.kogito</groupId>
  <artifactId>kogito-addons-quarkus-source-files</artifactId> <3>
</dependency>
----
...
<3> Exposes the workflow definition sources.
