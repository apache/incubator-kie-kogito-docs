...
{data_index_ref} service does not initialise its database schema automatically. To initialise the database schema, you need to enable Flyway migration by setting QUARKUS_FLYWAY_MIGRATE_AT_START=true.
