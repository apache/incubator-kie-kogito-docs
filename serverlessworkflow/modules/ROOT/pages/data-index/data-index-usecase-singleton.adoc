...
:flow_examples_operator_url: {kogito_sw_examples_url}/serverless-workflow-dataindex-operator-use-cases
...
You can directly access the UseCase1 example application we are going to follow at link:{flow_examples_operator_url}[{product_name} Use Cases repository].
...
.Procedure
. After cloning the link:{flow_examples_operator_url}[SonataFlow Data Index Use Cases]. Open a terminal and run the following commands
