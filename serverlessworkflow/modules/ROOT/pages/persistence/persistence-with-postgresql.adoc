...
The following table serves as a quick reference of commonly used persistence configuration properties supported in 
ifeval::["{context}" == ""]
Serverless Workflow.
endif::[]
ifeval::["{context}" != ""]
...
You can define these properties in the `application.properties` file of your project.
