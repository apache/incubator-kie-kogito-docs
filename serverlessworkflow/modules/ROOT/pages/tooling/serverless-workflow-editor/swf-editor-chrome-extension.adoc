...
You can install the Chrome extension for the Serverless Workflow editor to view and edit the workflow specification fles in GitHub.
...
.Procedure
. Create a Serverless Workflow file (`.sw.json` or `.sw.yaml`).
. Push the created Serverless Workflow file to GitHub, or you can go to the GitHub page and click on the Serverless Workflow file to open the editor.
+
--
