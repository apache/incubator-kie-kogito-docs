...
The Chrome Extension for the Kogito Serverless Workflow Editor allows you to view and edit link:{spec_website_url}[CNCF Serverless Workflow Specification] files in GitHub.
