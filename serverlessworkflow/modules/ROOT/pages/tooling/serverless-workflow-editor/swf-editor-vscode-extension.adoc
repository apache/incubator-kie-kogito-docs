...
This document describes how to install and use the VS Code extension for Serverless Worklfow editor, along with how to load OpenAPI files using the extension.
...
* link:{red_hat_auth_vscode_marketplace_url}[Redhat authentication extension] is installed.
