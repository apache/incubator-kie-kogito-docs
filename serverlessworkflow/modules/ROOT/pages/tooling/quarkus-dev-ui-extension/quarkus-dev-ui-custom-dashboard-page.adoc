...
In Kogito Serverless Workflow Tools, the Dashboards page is used to displays the available dashboard files. The page displays a list of available dashboard and add filters to the list.
...
* *Name*: displays the name of a custom dashboard.
* *Last Modified*: displays the time reference indicating when the custom dashboard is last updated.
