...
:compat-mode!:
// Metadata:
:description: Serverless Logic Sandbox openshift integration
:keywords: kogito, workflow, serverless, editor, sandbox, settings, openshift, integration

Integrate your sandbox with Red Hat® OpenShift®, an enterprise-ready Kubernetes container platform, allowing your projects to be deployed and tested online.

[[proc-setting-kie-sandbox-extended-services-serverless-logic-sandbox]]
== Setting up KIE Sandbox Extended Services

The KIE Sandbox Extended Services tool is required to proxy OpenShift Sandbox requests, thus making it possible to deploy and monitor projects.

.Prerequisites
* None.

.Procedure
. In the Serverless Logic Sandbox, click on the **Cog wheel** on the top right corner and go to the **KIE Sandbox Extended Services** tab;
...
[[proc-connecting-openshift-instance-serverless-logic-sandbox]]
...
. You'll need your OpenShift project name, the API server and an access token:
...
image::tooling/serverless-logic-sandbox/serverless-logic-sandbox-openshift-project.png[]
--
...
image::tooling/serverless-logic-sandbox/serverless-logic-sandbox-openshift-info.png[]
--
. Having all that information, go back to the Serverless Logic Sandbox, click on the **Cog wheel** on the top right corner and go to the **OpenShift** tab;
...
Now you should be ready to start deploying your projects with the Serverless Logic Sandbox, check how to do it xref:tooling/serverless-logic-sandbox/serverless-logic-sandbox-deploy-projects.adoc[here].
