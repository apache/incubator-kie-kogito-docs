...
:compat-mode!:
// Metadata:
:description: Serverless Logic Sandbox Red Hat OpenShift Application and Data Services integration
:keywords: kogito, workflow, serverless, editor, sandbox, settings, red hat, application, data, services, integration

Some Serverless Logic Sandbox features require integration with Red Hat OpenShift Application and Data Services. Uploading OpenAPI specifications to a Service Registry and deploying Serverless Workflows that required an Apache Kafka stream are some of the examples.

On this page, you'll configure all the settings needed for complete integration.

[[proc-setting-service-account-serverless-logic-sandbox]]
== Setting up a Service Account

Create or use a Service Account from your Red Hat OpenShift Application and Data Services console and add it to the Serverless Logic Sandbox settings tab.
...
. In the Serverless Logic Sandbox, click on the **Cog wheel** on the top right corner and go to the **Service Account** tab;
...
[[proc-setting-service-registry-serverless-logic-sandbox]]
== Setting up a Service Registry

Create or use a Service Registry instance from your Red Hat OpenShift Application and Data Services console and add it to the Serverless Logic Sandbox settings tab.
...
. Create a Service Registry instance on Red Hat Openshift Application and Data Services console (if you already have one, skip this step):
  ...
  * From the dropdown, select your Service Account desired (the same you configured on the Serverless Logic Sandbox);
...
. In the Serverless Logic Sandbox, click on the **Cog wheel** on the top right corner and go to the **Service Registry** tab;
...
[[proc-setting-apache-kafka-serverless-logic-sandbox]]
== Setting up Streams for Apache Kafka

Create or use a Kafka instance from your Red Hat OpenShift Application and Data Services console and add it to the Serverless Logic Sandbox settings tab.
...
. In the Serverless Logic Sandbox, click on the **Cog wheel** on the top right corner and go to the **Streams for Apache Kafka** tab;
