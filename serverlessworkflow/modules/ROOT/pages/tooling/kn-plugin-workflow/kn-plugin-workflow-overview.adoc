...
`kn-plugin-workflow` is a plugin for the Knative Client to enable users to quickly set up a local Kogito Serverless Workflow project from the command line.
...
You can download the latest binaries from the {kie_tools_releases_page_url}[KIE Tooling Releases] page.
