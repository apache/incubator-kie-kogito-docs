...
+
--
The workflow files in {serverless_logic_web_tools_name} are saved automatically after each change. The files are persisted in the browser, but you can sychronize the file using GitHub integration. For more information about GitHub integration, see xref:tooling/serverless-logic-web-tools/serverless-logic-web-tools-github-integration.adoc[Integrating your {product_name} project in GitHub using {serverless_logic_web_tools_name}].
--
