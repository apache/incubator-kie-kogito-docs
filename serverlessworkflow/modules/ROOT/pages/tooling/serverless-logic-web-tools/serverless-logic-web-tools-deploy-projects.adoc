...
You can deploy your {product_name} projects to an OpenShift instance using the OpenShift integration. The OpenShift integration allows you test your implementations in a live environment. 
