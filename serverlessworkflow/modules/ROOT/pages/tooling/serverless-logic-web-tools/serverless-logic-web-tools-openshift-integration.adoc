...
:compat-mode!:
// Metadata:
:description: Serverless Logic Web Tools openshift integration
...
.Procedure
. In the Serverless Logic Web Tools, click on the **Cog wheel** on the top right corner and go to the **KIE Sandbox Extended Services** tab;
...
--
. Having all that information, go back to the Serverless Logic Web Tools, click on the **Cog wheel** on the top right corner and go to the **OpenShift** tab;
...
Now you should be ready to start deploying your projects with the Serverless Logic Web Tools, check how to do it xref:tooling/serverless-logic-web-tools/serverless-logic-web-tools-deploy-projects.adoc[here].
