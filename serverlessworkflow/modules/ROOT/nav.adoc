...
* Data Index
** xref:data-index/data-index-core-concepts.adoc[Data Index Core concepts]
** xref:data-index/data-index-service.adoc[Data Index Service]
** xref:data-index/data-index-quarkus-extension.adoc[Data Index Quarkus Extension]
* Use Cases
